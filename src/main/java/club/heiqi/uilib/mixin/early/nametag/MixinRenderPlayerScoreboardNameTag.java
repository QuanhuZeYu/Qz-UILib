...
/** 仅捕获玩家计分板标签最终进入 {@code func_147906_a} 的调用点。 */
@Mixin(value = RenderPlayer.class, priority = 900)
public abstract class MixinRenderPlayerScoreboardNameTag {

    /** 保留睡眠与非睡眠分支传入的完整参数和既有 wrapper 链。 */
    @WrapOperation(
            method = "func_96449_a(Lnet/minecraft/client/entity/AbstractClientPlayer;DDDLjava/lang/String;FD)V",
            at = @At(
                    value = "INVOKE",
                    target = "Lnet/minecraft/client/renderer/entity/RenderPlayer;func_147906_a("
                            + "Lnet/minecraft/entity/Entity;Ljava/lang/String;DDDI)V"),
            require = 2,
            expect = 2,
            allow = 2)
    private void qzuilib$deferScoreboardNameTag(
            final RenderPlayer renderer,
            final Entity entity,
            final String text,
            final double x,
            final double y,
