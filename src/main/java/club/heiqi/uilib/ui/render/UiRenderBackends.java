 ...
 *
 * <p>{@link UiRenderBackend} 是 scene 抽象层可见的最小出口契约，刻意不含
...
public final class UiRenderBackends {
    ...
    public static void backdropFilter(UiRenderBackend backend, int left, int top, int right, int bottom,
        ...
        backdropFilter(backend, left, top, right, bottom, blurRadius, saturation, cornerRadius,
     ...
     * @param bottom       底部坐标
     * @param blurRadius   模糊半径像素
     * @param saturation   饱和度倍率；material 非空时作材质 vibrancy 乘子
     * @param cornerRadius 圆角半径
