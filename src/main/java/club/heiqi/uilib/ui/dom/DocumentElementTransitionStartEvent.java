 ...
 * HTML-like 元素过渡开始事件。
 */
public final class DocumentElementTransitionStartEvent extends AbstractDocumentElementEvent {

    private final DocumentAnimationProperty property;
    private final long elapsedTimeNanos;
    private final long timeNanos;

    public DocumentElementTransitionStartEvent(ElementNode target, ElementNode currentTarget,
