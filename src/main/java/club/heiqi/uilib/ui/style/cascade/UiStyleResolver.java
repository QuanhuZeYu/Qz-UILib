...
public final class UiStyleResolver {
    ...
    private static <T> T readDeclarationValue(UiStyleDeclaration declaration, UiStyleProperty property) {
        switch (property) {
            case DISPLAY: return (T) declaration.getDisplay();
            case WIDTH: return (T) declaration.getWidth();
            case HEIGHT: return (T) declaration.getHeight();
            case BOX_SIZING: return (T) declaration.getBoxSizing();
            case POSITION: return (T) declaration.getPosition();
            case TOP: return (T) declaration.getTop();
            case RIGHT: return (T) declaration.getRight();
            case BOTTOM: return (T) declaration.getBottom();
            case LEFT: return (T) declaration.getLeft();
            case Z_INDEX: return (T) declaration.getZIndex();
            case MARGIN: return (T) declaration.getMargin();
            case PADDING: return (T) declaration.getPadding();
            case BORDER_WIDTH: return (T) declaration.getBorderWidth();
            case BORDER_RADIUS: return (T) declaration.getBorderRadius();
            case OVERFLOW_X: return (T) declaration.getOverflowX();
            case OVERFLOW_Y: return (T) declaration.getOverflowY();
            case FLEX_DIRECTION: return (T) declaration.getFlexDirection();
            case ALIGN_ITEMS: return (T) declaration.getAlignItems();
            case JUSTIFY_CONTENT: return (T) declaration.getJustifyContent();
            case VERTICAL_ALIGN: return (T) declaration.getVerticalAlign();
            case ROW_GAP: return (T) declaration.getRowGap();
            ...
            case TEXT_COLOR: return (T) declaration.getTextColor();
            case TRANSITION_PROPERTIES: return (T) declaration.getTransitionProperties();
            case TRANSITION_DURATION: return (T) declaration.getTransitionDurationNanos();
            case TRANSITION_DELAY: return (T) declaration.getTransitionDelayNanos();
            case TRANSITION_TIMING: return (T) declaration.getTransitionTimingFunction();
            case ANIMATION_NAME: return (T) declaration.getAnimationName();
            case ANIMATION_DURATION: return (T) declaration.getAnimationDurationNanos();
            case ANIMATION_DELAY: return (T) declaration.getAnimationDelayNanos();
            case ANIMATION_ITERATION_COUNT: return (T) declaration.getAnimationIterationCount();
            case ANIMATION_FILL_MODE: return (T) declaration.getAnimationFillMode();
            case ANIMATION_TIMING: return (T) declaration.getAnimationTimingFunction();
            case BACKDROP_BLUR_RADIUS: return (T) declaration.getBackdropBlurRadius();
            case BACKDROP_SATURATION: return (T) declaration.getBackdropSaturation();
            case LINE_HEIGHT: return (T) declaration.getLineHeight();
            case TEXT_ALIGN: return (T) declaration.getTextAlign();
            case WHITE_SPACE: return (T) declaration.getWhiteSpace();
            case TEXT_OVERFLOW: return (T) declaration.getTextOverflow();
            case VISIBILITY: return (T) declaration.getVisibility();
            case MIN_WIDTH: return (T) declaration.getMinWidth();
            case MAX_WIDTH: return (T) declaration.getMaxWidth();
            case MIN_HEIGHT: return (T) declaration.getMinHeight();
            case MAX_HEIGHT: return (T) declaration.getMaxHeight();
            case FLEX_BASIS: return (T) declaration.getFlexBasis();
            case ALIGN_SELF: return (T) declaration.getAlignSelf();
            ...
            case OUTLINE: return (T) declaration.getOutline();
            case BORDER_WIDTH_SIDES: return (T) declaration.getBorderWidthSides();
            case BORDER_COLORS: return (T) declaration.getBorderColors();
            case LETTER_SPACING: return (T) declaration.getLetterSpacing();
            case WORD_BREAK: return (T) declaration.getWordBreak();
