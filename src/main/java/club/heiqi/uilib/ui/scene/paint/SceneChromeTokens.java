 ...
 * 纯静态常量收口，非主题引擎。色值一律 0xFF ARGB。
 *
 * <p>旧的两个外壳写入 helper（{@code applyPanelChrome} 实底四件套 / {@code applyOuterShell}
 * 无底边框壳）已按「表面写入权治理」第 2 步删除：它们直接写节点底色/边框/圆角，属通用绑定器
 * 之外的第二外观通道，生产引用为零。本类保留纯常量查表职责。</p>
 */
