...
public final class PaintCommand {
    ...
    /**
     * 创建「退出 transform 离屏图层作用域」边界命令（B6 FBO 方案，与 {@link #pushTransformLayer} 配对）。
     *
     * <p>无坐标无 transform 语义，回放器遇此命令调用 {@code ctx.popTransformLayer()}。
     * 与 {@link #pushTransformLayer} 由绘制引擎递归骨架保证严格配对。</p>
     *
    ...
    public String toString() {
        ...
        if (type == PaintCommandType.BACKGROUND) {
            ...
            sb.append(", left=").append(left)
              ...
              .append(", right=").append(right)
              .append(", bottom=").append(bottom)
              .append(", imageSourceIdentity=").append(System.identityHashCode(imageSource));
            ...
            sb.append(", left=").append(left)
              ...
              .append(", bottom=").append(bottom)
              .append(", cornerRadius=").append(cornerRadius);
        } else if (type == PaintCommandType.PUSH_TRANSFORM || type == PaintCommandType.PUSH_TRANSFORM_LAYER) {
            sb.append(", left=").append(left)
              .append(", top=").append(top)
              .append(", right=").append(right)
              .append(", bottom=").append(bottom)
