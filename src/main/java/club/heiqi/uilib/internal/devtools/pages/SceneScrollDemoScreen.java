...
/**
 * 新栈 ui.scene 滚动 demo 宿主壳。
 */
final class SceneScrollDemoScreen extends McScreenBridge {
    ...
    SceneScrollDemoScreen(GuiScreen parentScreen) {
        super(parentScreen, new SceneScrollHostWidget(new LwjglInputSource(new LwjglStateReader())));
    }
