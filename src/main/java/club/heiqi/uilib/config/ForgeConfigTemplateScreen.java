...
public class ForgeConfigTemplateScreen extends BaseScreen {
    ...
    ForgeConfigTemplateScreen(GuiScreen parentScreen, Spec spec, TextMeasureService textMeasureService,
        ...
        ConfigTemplateDocumentBuilder.Result buildResult = new ConfigTemplateDocumentBuilder(this, spec,
                bindings, bindingsByKey, missingCategories, saveButton, restoreCurrentButton,
    ...
    HtmlLikeDocumentWidget getDocumentWidgetForBindings() {
        return documentWidget;
    }
