    ...
    public static ConfigSchema create() {
        return ConfigSchema.builder("qzuilib")
                ...
                .section("fontSystem")
                    ...
                    .number("smoothRangeMin").defaultValue(Double.valueOf(0.0)).range(0, Double.MAX_VALUE)
                        .label("smoothRangeMin").helper("平滑下界").build()
                    .number("smoothRangeMax").defaultValue(Double.valueOf(0.9)).range(0, Double.MAX_VALUE)
                    ...
                    .number("aaStrength").defaultValue(Double.valueOf(12.0)).range(1, Double.MAX_VALUE)
                ...
                .section("fontSizeSetting")
                    .title("Font Size")
                    .number("awtCharSize").defaultValue(Double.valueOf(64.0)).range(8, Double.MAX_VALUE)
                        .label("awtCharSize").helper("字符生成分辨率；与 charSize 的比值是字体层缩放因子").build()
                    .number("charSize").defaultValue(Double.valueOf(9.0)).range(1, Double.MAX_VALUE)
