...
public class Config {
    ...
    public static double radius = 2, smoothRangeMin = 0, smoothRangeMax = 0.5, colorGain = 1,
            spaceWidth = 4, characterSpacing = 0.1, shadowOffsetX = 0.5, shadowOffsetY = 0.5,
            lineSpacing = 0.1, renderOffset = 0, alphaGain = 0.3, shrink = 1;
    /**fontSystem中的配置*/
    ...
    public static double awtCharSize = 64, charSize = 8, stackFontSize = 8;
    ...
    public void load() {
        ...
        radius = config.get(FONT_SYSTEM, "radius", 2, "蒙版模糊半径", 0, Double.MAX_VALUE).getDouble();
