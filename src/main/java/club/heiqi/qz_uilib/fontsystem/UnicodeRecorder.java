...
public class UnicodeRecorder {
    ...
    static {
        // 手动按起始码点从小到大插入
        addRange("英文", ENG_START, ENG_END);                    // 0x0020
        addRange("英文扩展", ENG_EXT_START, ENG_EXT_END);        // 0x0080
        addRange("通用标点符号", GENERAL_PUNCTUATION_START, GENERAL_PUNCTUATION_END); // 0x2000~0x206F
