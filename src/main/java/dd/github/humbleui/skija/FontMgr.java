...
public class FontMgr extends RefCnt {
     ...
     * Note that most systems don't have a default system family, so passing null
     * will often
     ...
     */
    public Typeface matchFamilyStyleCharacter(@Nullable String familyName, FontStyle style, @Nullable String[] bcp47,
            int character) {
        try {
            Stats.onNativeCall();
    ...
    @Nullable
    public Typeface matchFamiliesStyleCharacter(String[] families, FontStyle style, @Nullable String[] bcp47,
            int character) {
        for (String family : families) {
    ...
    /**
     * Create a typeface for the specified data or null if the data is not
     * recognized.
     * The caller must call {@link #close()} on the returned object if it is not
     * null.
     */
     ...
     * or null if the data is not recognized. The caller must call {@link #close()}
     * on
    ...
    public static native long _nMatchFamilyStyleCharacter(long ptr, String familyName, int fontStyle, String[] bcp47,
            int character);
