...
public class BackendRenderTarget extends Managed {
    ...
    public static BackendRenderTarget makeGL(int width, int height, int sampleCnt, int stencilBits, int fbId,
            int fbFormat) {
        Stats.onNativeCall();
     ...
     * @param texturePtr pointer to ID3D12Resource texture resource object; must be
     *                   not zero
    ...
    @NotNull
    @Contract("_, _, _, _, _, _ -> new")
    public static BackendRenderTarget makeDirect3D(int width, int height, long texturePtr, int format, int sampleCnt,
            int levelCnt) {
        Stats.onNativeCall();
    ...
    @ApiStatus.Internal
    public static native long _nMakeDirect3D(int width, int height, long texturePtr, int format, int sampleCnt,
            int levelCnt);
