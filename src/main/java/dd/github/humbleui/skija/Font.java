...
public class Font extends Managed {
    ...
    @ApiStatus.Internal
    public FontMetrics _metrics = null;
    @ApiStatus.Internal
    public Float _spacing = null;
     ...
     *
     * @param typeface typeface and style used to draw and measure text. Pass null
     *                 for default
     */
    ...
    /**
     * @return true if font engine may return glyphs from font bitmaps instead of
     *         from outlines
     */
    ...
    /**
     * Returns true if baselines will be snapped to pixel positions when the current
     * transformation
    ...
    /**
     * Sets whether to always hint glyphs. If forceAutoHinting is set, instructs the
     * font manager to always hint glyphs. Only affects platforms that use FreeType
     * as the font manager.
     *
     ...
     *
     * For outline fonts 'true' means font and glyph metrics should ignore hinting
     * and rounding.
     * Note that some bitmap formats may not be able to scale linearly and will
     * ignore this flag.
     *
    ...
    /**
     * Requests that baselines be snapped to pixels when the current transformation
     * matrix is axis
     * aligned.
     *
    ...
    /**
     * Sets level of glyph outline adjustment. Does not check for valid values of
     * hintingLevel.
     */
    ...
    /**
     * Returns a font with the same attributes of this font, but with the specified
     * size.
     */
    ...
    /**
     * Sets text size in points. Has no effect if value is not greater than or equal
     * to zero.
     */
    ...
    /**
     * @return the glyph that corresponds to the specified unicode code-point (in
     *         UTF32 encoding). If the unichar is not supported, returns 0
     */
     ...
     * Degenerate contours in the glyph outline will be skipped. If glyph is
     * described by a bitmap, returns null.
     */
    @Nullable
    ...
    /**
     * Returns FontMetrics associated with Typeface. Results are scaled by text size
     * but does not take into account
     * dimensions required by text scale, text skew, fake bold, style stroke, and
     * {@link PathEffect}.
     */
    @NotNull
     ...
     * required by stroking and SkPathEffect.
     */
    ...
    @ApiStatus.Internal
    public static native long _nMakeTypeface(long typefacePtr);

    @ApiStatus.Internal
    public static native long _nMakeTypefaceSize(long typefacePtr, float size);

    @ApiStatus.Internal
    public static native long _nMakeTypefaceSizeScaleSkew(long typefacePtr, float size, float scaleX, float skewX);
    ...
    @ApiStatus.Internal
    public static native boolean _nIsAutoHintingForced(long ptr);

    @ApiStatus.Internal
    public static native boolean _nAreBitmapsEmbedded(long ptr);

    @ApiStatus.Internal
    public static native boolean _nIsSubpixel(long ptr);

    @ApiStatus.Internal
    public static native boolean _nAreMetricsLinear(long ptr);

    @ApiStatus.Internal
    public static native boolean _nIsEmboldened(long ptr);

    @ApiStatus.Internal
    public static native boolean _nIsBaselineSnapped(long ptr);

    @ApiStatus.Internal
    public static native void _nSetAutoHintingForced(long ptr, boolean value);

    @ApiStatus.Internal
    public static native void _nSetBitmapsEmbedded(long ptr, boolean value);

    @ApiStatus.Internal
    public static native void _nSetSubpixel(long ptr, boolean value);

    @ApiStatus.Internal
    public static native void _nSetMetricsLinear(long ptr, boolean value);

    @ApiStatus.Internal
    public static native void _nSetEmboldened(long ptr, boolean value);

    @ApiStatus.Internal
    public static native void _nSetBaselineSnapped(long ptr, boolean value);

    @ApiStatus.Internal
    public static native int _nGetEdging(long ptr);

    @ApiStatus.Internal
    public static native void _nSetEdging(long ptr, int value);

    @ApiStatus.Internal
    public static native int _nGetHinting(long ptr);

    @ApiStatus.Internal
    public static native void _nSetHinting(long ptr, int value);

    @ApiStatus.Internal
    public static native long _nGetTypeface(long ptr);

    @ApiStatus.Internal
    public static native long _nGetTypefaceOrDefault(long ptr);

    @ApiStatus.Internal
    public static native float _nGetSize(long ptr);

    @ApiStatus.Internal
    public static native float _nGetScaleX(long ptr);

    @ApiStatus.Internal
    public static native float _nGetSkewX(long ptr);

    @ApiStatus.Internal
    public static native void _nSetTypeface(long ptr, long typefacePtr);

    @ApiStatus.Internal
    public static native void _nSetSize(long ptr, float value);

    @ApiStatus.Internal
    public static native void _nSetScaleX(long ptr, float value);

    @ApiStatus.Internal
    public static native void _nSetSkewX(long ptr, float value);

    @ApiStatus.Internal
    public static native short[] _nGetStringGlyphs(long ptr, String str);

    @ApiStatus.Internal
    public static native short _nGetUTF32Glyph(long ptr, int uni);

    @ApiStatus.Internal
    public static native short[] _nGetUTF32Glyphs(long ptr, int[] uni);

    @ApiStatus.Internal
    public static native int _nGetStringGlyphsCount(long ptr, String str);

    @ApiStatus.Internal
    public static native Rect _nMeasureText(long ptr, String str, long paintPtr);

    @ApiStatus.Internal
    public static native float _nMeasureTextWidth(long ptr, String str, long paintPtr);

    @ApiStatus.Internal
    public static native float[] _nGetWidths(long ptr, short[] glyphs);

    @ApiStatus.Internal
    public static native Rect[] _nGetBounds(long ptr, short[] glyphs, long paintPtr);

    @ApiStatus.Internal
    public static native Point[] _nGetPositions(long ptr, short[] glyphs, float x, float y);

    @ApiStatus.Internal
    public static native float[] _nGetXPositions(long ptr, short[] glyphs, float x);

    @ApiStatus.Internal
    public static native long _nGetPath(long ptr, short glyph);

    @ApiStatus.Internal
    public static native Path[] _nGetPaths(long ptr, short[] glyphs);

    @ApiStatus.Internal
    public static native FontMetrics _nGetMetrics(long ptr);

    @ApiStatus.Internal
    public static native float _nGetSpacing(long ptr);
}
