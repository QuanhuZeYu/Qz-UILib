...
public enum PathFillMode {
    /**
     * Specifies that "inside" is computed by a non-zero sum of signed edge
     * crossings.
     */
    WINDING,
    ...
    /**
     * Returns if FillType describes area outside Path geometry. The inverse fill
     * area
     * extends indefinitely.
     *
     * @return true if FillType is {@link #INVERSE_WINDING} or
     *         {@link #INVERSE_EVEN_ODD}
     */
