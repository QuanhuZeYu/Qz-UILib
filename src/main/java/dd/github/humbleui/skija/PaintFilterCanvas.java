...
public abstract class PaintFilterCanvas extends Canvas {
    ...
    /**
     * @param unrollDrawable if needed to filter nested drawable content using this
     *                       canvas (for drawables there is no paint to filter)
     */
     ...
     *
     * Note: The base implementation calls onFilter() for top-level/explicit paints
     * only.
     */
