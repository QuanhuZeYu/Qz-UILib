...
public class Shaper extends Managed {
    ...
    public TextBlob shape(String text, @NotNull Font font, @NotNull ShapingOptions opts, float width,
    ...
    public Shaper shape(String text,
        ...
        try (ManagedString textUtf8 = new ManagedString(text);
             ...
             IcuBidiRunIterator bidiIter = new IcuBidiRunIterator(textUtf8, false,
                        opts._leftToRight ? java.text.Bidi.DIRECTION_LEFT_TO_RIGHT
    ...
    public static native long _nShapeBlob(long ptr, String text, long fontPtr, ShapingOptions opts, float width,
            float offsetX, float offsetY);

    public static native long _nShapeLine(long ptr, String text, long fontPtr, ShapingOptions opts);

    public static native void _nShape(long ptr, long textPtr, Iterator<FontRun> fontIter, Iterator<BidiRun> bidiIter,
            Iterator<ScriptRun> scriptIter, Iterator<LanguageRun> langIter, ShapingOptions opts, float width,
            RunHandler runHandler);
}
