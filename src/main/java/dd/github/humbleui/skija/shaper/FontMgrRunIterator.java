...
public class FontMgrRunIterator extends ManagedRunIterator<FontRun> {
    ...
    public FontMgrRunIterator(ManagedString text, boolean manageText, Font font,
                              Iterator<LanguageRun> languageRunIterator, @NotNull ShapingOptions opts) {
    ...
    @ApiStatus.Internal
    public static native long _nMake(long textPtr, long fontPtr, Iterator<LanguageRun> languageRunIterator,
            ShapingOptions opts);
