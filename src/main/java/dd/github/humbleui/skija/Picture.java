...
public class Picture extends RefCnt {
     ...
     * commands are recorded, each command in the Picture is sent separately to
     * canvas.
     * </p>
     *
     * <p>
     * To add a single command to draw Picture to recording canvas, call
     * {@link Canvas#drawPicture} instead.
     * </p>
     *
     ...
     *
     * @see <a href=
     *      "https://fiddle.skia.org/c/@Picture_playback">https://fiddle.skia.org/c/@Picture_playback</a>
     */
     ...
     *
     * @see <a href=
     *      "https://fiddle.skia.org/c/@Picture_cullRect">https://fiddle.skia.org/c/@Picture_cullRect</a>
     */
     ...
     *
     * @see <a href=
     *      "https://fiddle.skia.org/c/@Picture_serialize">https://fiddle.skia.org/c/@Picture_serialize</a>
     */
     ...
     *
     * @see <a href=
     *      "https://fiddle.skia.org/c/@Picture_MakePlaceholder">https://fiddle.skia.org/c/@Picture_MakePlaceholder</a>
     */
     ...
     *
     * @see <a href=
     *      "https://fiddle.skia.org/c/@Picture_approximateOpCount">https://fiddle.skia.org/c/@Picture_approximateOpCount</a>
     */
     ...
     *
     * @see <a href=
     *      "https://fiddle.skia.org/c/@Picture_approximateBytesUsed">https://fiddle.skia.org/c/@Picture_approximateBytesUsed</a>
     */
    ...
    /**
     * Return a new shader that will draw with this picture. The tile rect is
     * considered
     ...
     * @param mode        How to filter the tiles
     * @param localMatrix Optional matrix used when sampling
     * @param tileRect    The tile rectangle in picture coordinates: this represents
     *                    the subset
     *                    (or superset) of the picture used when building a tile. It
     *                    is not
     *                    affected by localMatrix and does not imply scaling (only
     *                    translation
     *                    and cropping). If null, the tile rect is considered equal
     *                    to the picture
     *                    bounds.
     * @return Returns a new shader object. Note: this function never returns null.
     */
    ...
    @ApiStatus.Internal
    public static native long _nMakeFromData(long dataPtr /* , SkDeserialProcs */);

    @ApiStatus.Internal
    public static native void _nPlayback(long ptr, long canvasPtr, @Nullable BooleanSupplier abort);

    @ApiStatus.Internal
    public static native Rect _nGetCullRect(long ptr);

    @ApiStatus.Internal
    public static native int _nGetUniqueId(long ptr);

    @ApiStatus.Internal
    public static native long _nSerializeToData(long ptr /* , SkSerialProcs */);

    @ApiStatus.Internal
    public static native long _nMakePlaceholder(float left, float top, float right, float bottom);

    @ApiStatus.Internal
    public static native int _nGetApproximateOpCount(long ptr);

    @ApiStatus.Internal
    public static native long _nGetApproximateBytesUsed(long ptr);

    @ApiStatus.Internal
    public static native long _nMakeShader(long ptr, int tmx, int tmy, int filterMode, float[] localMatrix,
            Rect tileRect);
}
