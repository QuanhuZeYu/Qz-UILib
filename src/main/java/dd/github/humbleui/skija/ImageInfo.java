 ...
 *
 * <p>
 * ImageInfo contains dimensions, the pixel integral width and height. It
 * encodes
...
public class ImageInfo {
    ...
    public ImageInfo(int width, int height, int colorType, int alphaType, long colorSpace) {
        this(width, height, ColorType._values[colorType], ColorAlphaType._values[alphaType],
                colorSpace == 0 ? null : new ColorSpace(colorSpace));
    }
     ...
     *
     * @see <a href=
     *      "https://fiddle.skia.org/c/@ImageInfo_MakeS32">https://fiddle.skia.org/c/@ImageInfo_MakeS32</a>
     */
    @NotNull
    @Contract("_, _, _ -> new")
    ...
    /**
     * @return ImageInfo with {@link ColorType#N32} and
    ...
    /**
     * @return ImageInfo with {@link ColorType#ALPHA_8} and
     *         {@link ColorAlphaType#PREMUL}
     */
    @NotNull
    @Contract("_, _ -> new")
    ...
    /**
     * @return ImageInfo with {@link ColorType#UNKNOWN} and
    ...
    /**
     * Returns minimum bytes per row, computed from pixel getWidth() and ColorType,
     * which
     ...
     * rowBytes is smaller than {@link #getMinRowBytes()}, even though result may be
     * incorrect.
     * </p>
     *
     ...
     *
     * @see <a href=
     *      "https://fiddle.skia.org/c/@ImageInfo_computeOffset">https://fiddle.skia.org/c/@ImageInfo_computeOffset</a>
     */
     ...
     *
     * @see <a href=
     *      "https://fiddle.skia.org/c/@ImageInfo_computeByteSize">https://fiddle.skia.org/c/@ImageInfo_computeByteSize</a>
     */
    ...
    public boolean equals(final Object o) {
        ...
        if (this.getHeight() != other.getHeight())
            return false;
        final Object this$_colorInfo = this.getColorInfo();
        final Object other$_colorInfo = other.getColorInfo();
        if (this$_colorInfo == null ? other$_colorInfo != null : !this$_colorInfo.equals(other$_colorInfo))
            return false;
        return true;
    }
    ...
    public int hashCode() {
        ...
        final Object $_colorInfo = this.getColorInfo();
    ...
    public String toString() {
        return "ImageInfo(_colorInfo=" + this.getColorInfo() + ", _width=" + this.getWidth() + ", _height="
                + this.getHeight() + ")";
    }
