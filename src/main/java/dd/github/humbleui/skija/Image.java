...
public class Image extends RefCnt implements IHasImageInfo {
    ...
    /**
     * <p>
     * Creates Image from an OpenGL texture.
     * </p>
     *
     * <p>
     * Image is returned if the texture is valid. Valid texture parameters include:
     * </p>
     * <ul>
     * <li>textureId is a valid OpenGL texture ID;</li>
     * <li>width and height are greater than zero;</li>
     * <li>ColorType and AlphaType are valid, and ColorType is not
     * ColorType.UNKNOWN;</li>
     ...
     * @return Image
     */
    public static Image adoptGLTextureFrom(DirectContext context, int textureId, int target, int width, int height,
            int format, SurfaceOrigin surfaceOrigin, ColorType colorType) {
        try {
            Stats.onNativeCall();
     ...
     *
     * @see <a href=
     *      "https://fiddle.skia.org/c/@Image_MakeRasterCopy">https://fiddle.skia.org/c/@Image_MakeRasterCopy</a>
     */
     ...
     *
     * @see <a href=
     *      "https://fiddle.skia.org/c/@Image_MakeFromBitmap">https://fiddle.skia.org/c/@Image_MakeFromBitmap</a>
     */
    @NotNull
    @Contract("_ -> new")
    ...
    /**
     * Returns a ImageInfo describing the width, height, color type, alpha type, and
     * color space
     * of the Image.
     *
    ...
    /**
     * @deprecated - use {@link EncoderPNG#encode(Image)},
     *             {@link EncoderJPEG#encode(Image)} or
     *             {@link EncoderWEBP#encode(Image)}
     */
    @Deprecated
    ...
    /**
     * @deprecated - use {@link EncoderPNG#encode(Image, EncodePNGOptions)},
     *             {@link EncoderJPEG#encode(Image, EncodeJPEGOptions)} or
     *             {@link EncoderWEBP#encode(Image, EncodeWEBPOptions)}
     */
    @Deprecated
     ...
     *
     * @see <a href=
     *      "https://fiddle.skia.org/c/@Image_peekPixels">https://fiddle.skia.org/c/@Image_peekPixels</a>
     */
    @Nullable
    ...
    /**
     * <p>
     * Copies Rect of pixels from Image to Bitmap. Copy starts at offset (srcX,
     * srcY),
     * and does not exceed Image (getWidth(), getHeight()).
     * </p>
     *
     * <p>
     * dst specifies width, height, ColorType, AlphaType, and ColorSpace of
     * destination.
     * </p>
     *
     * <p>
     ...
     *
     * <p>
     * Returns false if abs(srcX) &gt;= Image.getWidth(), or if abs(srcY) &gt;=
     * Image.getHeight().
     * </p>
     *
     * <p>
     * If cache is true, pixels may be retained locally, otherwise pixels are not
    ...
    @ApiStatus.Internal
    public static native long _nAdoptGLTextureFrom(long contextPtr, int textureId, int target, int width, int height,
            int format, int surfaceOrigin, int colorType);

    @ApiStatus.Internal
    public static native long _nMakeRasterFromBytes(int width, int height, int colorType, int alphaType,
            long colorSpacePtr, byte[] pixels, long rowBytes);

    @ApiStatus.Internal
    public static native long _nMakeRasterFromData(int width, int height, int colorType, int alphaType,
            long colorSpacePtr, long dataPtr, long rowBytes);

    @ApiStatus.Internal
    public static native long _nMakeRasterFromBitmap(long bitmapPtr);

    @ApiStatus.Internal
    public static native long _nMakeRasterFromPixmap(long pixmapPtr);

    @ApiStatus.Internal
    public static native long _nMakeDeferredFromEncodedBytes(byte[] bytes);
    ...
    @ApiStatus.Internal
    public static native boolean _nPeekPixelsToPixmap(long ptr, long pixmapPtr);

    @ApiStatus.Internal
    public static native boolean _nScalePixels(long ptr, long pixmapPtr, long samplingOptions, boolean cache);

    @ApiStatus.Internal
    public static native boolean _nReadPixelsBitmap(long ptr, long contextPtr, long bitmapPtr, int srcX, int srcY,
            boolean cache);

    @ApiStatus.Internal
    public static native boolean _nReadPixelsPixmap(long ptr, long pixmapPtr, int srcX, int srcY, boolean cache);
}
