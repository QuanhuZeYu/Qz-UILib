...
public class MaskFilter extends RefCnt {
    ...
    // public MaskFilter makeEmboss(float blurSigma, float lightDirectionX, float
    // lightDirectionY, float lightDirectionZ, int lightPad, int lightAmbient, int
    // lightSpecular) {
    // Native.onNativeCall();
    // return new MaskFilter(_nMakeEmboss(blurSigma, lightDirectionX,
    // lightDirectionY, lightDirectionZ, lightPad, lightAmbient, lightSpecular));
    // }
    ...
    // public static native long _nMakeEmboss(float sigma, float x, float y, float
    // z, int pad, int ambient, int specular);
