...
public class Region extends Managed {
    ...
    public boolean op(IRect rect, Region r, Op op) {
        try {
            Stats.onNativeCall();
            return _nOpIRectRegion(_ptr, rect._left, rect._top, rect._right, rect._bottom, Native.getPtr(r),
                    op.ordinal());
        } finally {
            ReferenceUtil.reachabilityFence(this);
            ReferenceUtil.reachabilityFence(r);
    ...
    public boolean op(Region r, IRect rect, Op op) {
        try {
            Stats.onNativeCall();
            return _nOpRegionIRect(_ptr, Native.getPtr(r), rect._left, rect._top, rect._right, rect._bottom,
                    op.ordinal());
        } finally {
            ReferenceUtil.reachabilityFence(this);
            ReferenceUtil.reachabilityFence(r);
    ...
    public static native boolean _nOpIRectRegion(long ptr, int left, int top, int right, int bottom, long regionPtr,
            int op);

    public static native boolean _nOpRegionIRect(long ptr, long regionPtr, int left, int top, int right, int bottom,
            int op);
