...
public class Bitmap extends Managed implements IHasImageInfo {
     ...
     *
     * Use {@link #setImageInfo(ImageInfo, long)} to associate ColorType,
     * ColorAlphaType, width, and height after Bitmap has been created.
     *
     * @see <a href=
     *      "https://fiddle.skia.org/c/@Bitmap_empty_constructor">https://fiddle.skia.org/c/@Bitmap_empty_constructor</a>
     */
    public Bitmap() {
        this(_nMake());
        Stats.onNativeCall();
     ...
     *
     * @see <a href=
     *      "https://fiddle.skia.org/c/@Bitmap_copy_const_SkBitmap">https://fiddle.skia.org/c/@Bitmap_copy_const_SkBitmap</a>
     */
    @NotNull
    @Contract("-> new")
     ...
     *
     * @see <a href=
     *      "https://fiddle.skia.org/c/@Bitmap_swap">https://fiddle.skia.org/c/@Bitmap_swap</a>
     */
     ...
     * supplied to {@link #setImageInfo(ImageInfo)} is not large enough to hold a
     * row of pixels.
     *
     ...
     * value is {@link ColorAlphaType#UNKNOWN}.
     * </p>
     *
     * <p>
     * Returns true if current color type is {@link ColorType#UNKNOWN}.
     * Argument is ignored, and alpha type remains {@link ColorAlphaType#UNKNOWN}.
     * </p>
     *
     * <p>
     * Returns true if current color type is {@link ColorType#RGB_565} or
     * {@link ColorType#GRAY_8}. Argument is ignored, and alpha type remains
     * {@link ColorAlphaType#OPAQUE}.
     * </p>
     *
     * <p>
     * If current color type is {@link ColorType#ARGB_4444},
     * {@link ColorType#RGBA_8888},
     * {@link ColorType#BGRA_8888}, or {@link ColorType#RGBA_F16}: returns true
     * unless
     ...
     * {@link ColorAlphaType#UNKNOWN}, argument is ignored.
     * </p>
     *
     * <p>
     * If current color type is {@link ColorType#ALPHA_8}, returns true unless
     * argument is {@link ColorAlphaType#UNKNOWN} and current alpha type is not
     * {@link ColorAlphaType#UNKNOWN}. If current alpha type is
     * {@link ColorAlphaType#UNKNOWN}, argument is ignored. If argument is
     * {@link ColorAlphaType#UNPREMUL}, it is treated as
     * {@link ColorAlphaType#PREMUL}.
     * </p>
     *
     * <p>
     ...
     *
     * @see <a href=
     *      "https://fiddle.skia.org/c/@Bitmap_setAlphaType">https://fiddle.skia.org/c/@Bitmap_setAlphaType</a>
     */
     ...
     * Does not include unused memory on last row when getRowBytesAsPixels() exceeds
     * getWidth().
     * Returns zero if height() or width() is 0.
     * Returns getHeight() times getRowBytes() if getColorType() is
     * {@link ColorType#UNKNOWN}.
     *
     ...
     *
     * @see <a href=
     *      "https://fiddle.skia.org/c/@Bitmap_isImmutable">https://fiddle.skia.org/c/@Bitmap_isImmutable</a>
     */
    ...
    /**
     * <p>
     * Sets internal flag to mark Bitmap as immutable. Once set, pixels can not
     * change.
     ...
     *
     * @see <a href=
     *      "https://fiddle.skia.org/c/@Bitmap_setImmutable">https://fiddle.skia.org/c/@Bitmap_setImmutable</a>
     */
    @NotNull
    @Contract("-> this")
     ...
     * {@link ColorType#UNKNOWN}; and ColorAlphaType to
     ...
     *
     * @see <a href=
     *      "https://fiddle.skia.org/c/@Bitmap_reset">https://fiddle.skia.org/c/@Bitmap_reset</a>
     */
    @NotNull
    @Contract("-> this")
    public Bitmap reset() {
     ...
     *
     * <p>
     * For {@link ColorType#RGB_565} or {@link ColorType#GRAY_8}: always
     ...
     * For {@link ColorType#ARGB_4444}: returns true if all pixel alpha values are
     * 15.
     * For {@link ColorType#RGBA_F16}: returns true if all pixel alpha values are
     * 1.0 or
     * greater.
     * </p>
     *
     * <p>
     * Returns false for {@link ColorType#UNKNOWN}.
     *
     ...
     *
     * @see <a href=
     *      "https://fiddle.skia.org/c/@Bitmap_getBounds_2">https://fiddle.skia.org/c/@Bitmap_getBounds_2</a>
     */
    @NotNull
     ...
     *
     * <p>
     * imageInfo.getAlphaType() may be altered to a value permitted by
     * imageInfo.getColorSpace().
     * If imageInfo.getColorType() is {@link ColorType#UNKNOWN},
     * imageInfo.getAlphaType() is
     * set to {@link ColorAlphaType#UNKNOWN}.
     * If imageInfo.colorType() is {@link ColorType#ALPHA_8} and
     * imageInfo.getAlphaType() is
     * {@link ColorAlphaType#UNPREMUL}, imageInfo.getAlphaType() is replaced by
     * {@link ColorAlphaType#PREMUL}.
     * If imageInfo.colorType() is {@link ColorType#RGB_565} or
     * {@link ColorType#GRAY_8},
     * imageInfo.getAlphaType() is set to {@link ColorAlphaType#OPAQUE}.
     * If imageInfo.colorType() is {@link ColorType#ARGB_4444},
     * {@link ColorType#RGBA_8888},
     * {@link ColorType#BGRA_8888}, or {@link ColorType#RGBA_F16}:
     * imageInfo.getAlphaType() remains
     * unchanged.
     * </p>
     *
     * <p>
     ...
     * - rowBytes is positive and less than imageInfo.getWidth() times
     ...
     *
     * @see <a href=
     *      "https://fiddle.skia.org/c/@Bitmap_setInfo">https://fiddle.skia.org/c/@Bitmap_setInfo</a>
     */
     ...
     *
     * <p>
     * rowBytes must equal or exceed imageInfo.getMinRowBytes(). If
     * imageInfo.getColorSpace() is
     * {@link ColorType#UNKNOWN}, rowBytes is ignored and treated as zero; for all
     * other
    ...
    /**
     * <p>
     * Sets ImageInfo to info following the rules in setImageInfo() and allocates
     * pixel
     * memory. Memory is zeroed.
     * </p>
     *
     * <p>
     * Returns false and calls reset() if ImageInfo could not be set, or memory
     * could
     ...
     * </p>
     *
     * @param imageInfo  contains width, height, ColorAlphaType, ColorType,
     *                   ColorSpace
     ...
     * Sets ImageInfo to info following the rules in setImageInfo() and allocates
     * pixel
     * memory. rowBytes must equal or exceed info.width() times
     * info.bytesPerPixel(),
     * or equal zero.
     * </p>
     *
    ...
    /**
     * <p>
     * Sets ImageInfo to info following the rules in
     * {@link #setImageInfo(ImageInfo, long)} and allocates pixel
     * memory.
     * </p>
     *
     * <p>
     ...
     * @return true if pixel storage is allocated
     * @see <a href=
     *      "https://fiddle.skia.org/c/@Bitmap_allocPixels_2">https://fiddle.skia.org/c/@Bitmap_allocPixels_2</a>
     */
     ...
     * the platform. Bitmap drawn to output device skips converting its pixel
     * format.
     *
    ...
    /**
     * Sets ImageInfo to width, height, and native color type; and allocates
     * pixel memory. If opaque is true, sets ImageInfo to
     * {@link ColorAlphaType#OPAQUE};
    ...
    /**
     * <p>
     * Sets ImageInfo to info following the rules in setImageInfo(), and creates
     * PixelRef
     * containing pixels and rowBytes.
     * </p>
     *
     * <p>
     * If ImageInfo could not be set, or rowBytes is less than
     * info.getMinRowBytes():
     * calls reset(), and returns false.
     * </p>
     *
     * @param info     contains width, height, SkAlphaType, SkColorType,
     *                 SkColorSpace
     ...
     *
     * <p>
     * Returns false if info().colorType() is {@link ColorType#UNKNOWN}, or
     * allocation fails.
     * </p>
     *
     ...
     *
     * @see <a href=
     *      "https://fiddle.skia.org/c/@Bitmap_pixelRefOrigin">https://fiddle.skia.org/c/@Bitmap_pixelRefOrigin</a>
     */
    @NotNull
     ...
     *
     * @see <a href=
     *      "https://fiddle.skia.org/c/@Bitmap_setPixelRef">https://fiddle.skia.org/c/@Bitmap_setPixelRef</a>
     */
    @NotNull
    @Contract("_, _, _ -> this")
     ...
     *
     * @see <a href=
     *      "https://fiddle.skia.org/c/@Bitmap_getGenerationID">https://fiddle.skia.org/c/@Bitmap_getGenerationID</a>
     */
     ...
     *
     * @see <a href=
     *      "https://fiddle.skia.org/c/@Bitmap_notifyPixelsChanged">https://fiddle.skia.org/c/@Bitmap_notifyPixelsChanged</a>
     */
    @NotNull
    @Contract("-> this")
     ...
     * {@link ColorType#GRAY_8} or {@link ColorType#RGB_565}, then alpha is ignored;
     * RGB is
     * treated as opaque. If getColorType() is {@link ColorType#ALPHA_8}, then RGB
     * is ignored.
     *
     ...
     *
     * @see <a href=
     *      "https://fiddle.skia.org/c/@Bitmap_eraseColor">https://fiddle.skia.org/c/@Bitmap_eraseColor</a>
     */
    @NotNull
    @Contract("_ -> this")
    public Bitmap erase(@NotNull Color4f color) {
        try {
            ...
            Stats.onNativeCall();
            _nErase4f(_ptr, color._r, color._g, color._b, color._a);
            return this;
        } finally {
            ReferenceUtil.reachabilityFence(this);
        }
     ...
     *
     * @see <a href=
     *      "https://fiddle.skia.org/c/@Bitmap_erase">https://fiddle.skia.org/c/@Bitmap_erase</a>
     */
    @NotNull
    @Contract("_, _ -> this")
    public Bitmap erase(@NotNull Color4f color, @NotNull IRect area) {
        try {
            ...
            Stats.onNativeCall();
            _nEraseRect4f(_ptr, color._r, color._g, color._b, color._a, area._left, area._top, area._right,
                    area._bottom);
            return this;
        } finally {
            ReferenceUtil.reachabilityFence(this);
    ...
    /**
     * Replaces pixel values inside area with color, interpreted as being in the
     * sRGB
     * ColorSpace. If area does not intersect getBounds(), call has no effect.
     *
     * If the getColorType() is {@link ColorType#GRAY_8} or
     * {@link ColorType#RGB_565},
     ...
     * Returns black with alpha if ColorType is {@link ColorType#ALPHA_8}.
     * </p>
     *
     * <p>
     * Input is not validated: out of bounds values of x or y returns undefined
     * values
     ...
     *
     * <p>
     * subset may be larger than getBounds(). Any area outside of getBounds() is
     * ignored.
     * </p>
     *
     * <p>
     ...
     *
     * @see <a href=
     *      "https://fiddle.skia.org/c/@Bitmap_extractSubset">https://fiddle.skia.org/c/@Bitmap_extractSubset</a>
     */
     ...
     * destination. dstRowBytes specifics the gap from one destination row to the
     * next.
     ...
     *
     * <p>
     * Pixels are copied only if pixel conversion is possible. If Bitmap
     * getColorType() is
     * {@link ColorType#GRAY_8}, or {@link ColorType#ALPHA_8}; dstInfo.colorType()
     * must match.
     * If Bitmap getClorType() is {@link ColorType#GRAY_8}, dstInfo.getColorSpace()
     * must match.
     * If Bitmap getAlphaType() is {@link ColorAlphaType#OPAQUE},
     * dstInfo.getAlphaType() must
     * match. If Bitmap getColorSpace() is null, dstInfo.getColorSpace() must match.
     * Returns
     ...
     * Returns false if abs(srcX) &gt;= getWidth(), or if abs(srcY) &gt;=
     * getHeight().
     * </p>
     *
     * @param dstInfo     destination width, height, ColorType, AlphaType,
     *                    ColorSpace
    ...
    public byte[] readPixels(@NotNull ImageInfo dstInfo, long dstRowBytes, int srcX, int srcY) {
        try {
            ...
            ReferenceUtil.reachabilityFence(this);
            ReferenceUtil.reachabilityFence(dstInfo._colorInfo._colorSpace);
        }
    }
     ...
     * @return null if alpha layer was not constructed in dst PixelRef, IPoint
     *         otherwise
     */
    @Nullable
     ...
     *
     * @see <a href=
     *      "https://fiddle.skia.org/c/@Bitmap_peekPixels">https://fiddle.skia.org/c/@Bitmap_peekPixels</a>
     */
    @Nullable
    ...
    public Shader makeShader(@NotNull FilterTileMode tmx,
        ...
        try {
            ...
            Stats.onNativeCall();
            return new Shader(_nMakeShader(_ptr, tmx.ordinal(), tmy.ordinal(), sampling._pack(),
                    localMatrix == null ? null : localMatrix._mat));
        } finally {
            ReferenceUtil.reachabilityFence(this);
        }
    }
    ...
    @ApiStatus.Internal
    public static native long _nGetPixmap(long ptr);
    ...
    @ApiStatus.Internal
    public static native boolean _nIsNull(long ptr);

    @ApiStatus.Internal
    public static native long _nGetRowBytes(long ptr);

    @ApiStatus.Internal
    public static native boolean _nSetAlphaType(long ptr, int alphaType);

    @ApiStatus.Internal
    public static native long _nComputeByteSize(long ptr);
    ...
    @ApiStatus.Internal
    public static native void _nSetVolatile(long ptr, boolean value);
    ...
    @ApiStatus.Internal
    public static native boolean _nSetImageInfo(long ptr, int width, int height, int colorType, int alphaType,
            long colorSpacePtr, long rowBytes);

    @ApiStatus.Internal
    public static native boolean _nAllocPixelsFlags(long ptr, int width, int height, int colorType, int alphaType,
            long colorSpacePtr, int flags);

    @ApiStatus.Internal
    public static native boolean _nAllocPixelsRowBytes(long ptr, int width, int height, int colorType, int alphaType,
            long colorSpacePtr, long rowBytes);

    @ApiStatus.Internal
    public static native boolean _nInstallPixels(long ptr, int width, int height, int colorType, int alphaType,
            long colorSpacePtr, byte[] pixels, long rowBytes);

    @ApiStatus.Internal
    public static native boolean _nAllocPixels(long ptr);

    @ApiStatus.Internal
    public static native long _nGetPixelRef(long ptr);

    @ApiStatus.Internal
    public static native long _nGetPixelRefOrigin(long ptr);

    @ApiStatus.Internal
    public static native void _nSetPixelRef(long ptr, long pixelRefPtr, int dx, int dy);

    @ApiStatus.Internal
    public static native boolean _nIsReadyToDraw(long ptr);
    ...
    @ApiStatus.Internal
    public static native void _nErase4f(long ptr, float r, float g, float b, float a);

    @ApiStatus.Internal
    public static native void _nEraseRect4f(long ptr, float r, float g, float b, float a, int left, int top, int right,
            int bottom);

    @ApiStatus.Internal
    public static native void _nErase(long ptr, int color);

    @ApiStatus.Internal
    public static native void _nEraseRect(long ptr, int color, int left, int top, int right, int bottom);
    ...
    @ApiStatus.Internal
    public static native boolean _nExtractSubset(long ptr, long dstPtr, int left, int top, int right, int bottom);

    @ApiStatus.Internal
    public static native byte[] _nReadPixels(long ptr, int width, int height, int colorType, int alphaType,
            long colorSpacePtr, long dstRowBytes, int srcX, int srcY);

    @ApiStatus.Internal
    public static native IPoint _nExtractAlpha(long ptr, long dstPtr, long paintPtr);

    @ApiStatus.Internal
    public static native ByteBuffer _nPeekPixels(long ptr);

    @ApiStatus.Internal
    public static native long _nMakeShader(long ptr, int tmx, int tmy, long samplingMode, float[] localMatrix);
}
