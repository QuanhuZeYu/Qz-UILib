...
public class Paint extends Managed {
     ...
     *
     * @see <a href=
     *      "https://fiddle.skia.org/c/@Paint_empty_constructor">https://fiddle.skia.org/c/@Paint_empty_constructor</a>
     */
    public Paint() {
     ...
     *
     * @see <a href=
     *      "https://fiddle.skia.org/c/@Paint_copy_const_SkPaint">https://fiddle.skia.org/c/@Paint_copy_const_SkPaint</a>
     */
    @NotNull
    @Contract("-> new")
    ...
    /**
     * Sets all Paint contents to their initial values. This is equivalent to
     * replacing
     * Paint with the result of Paint().
     *
     * @see <a href=
     *      "https://fiddle.skia.org/c/@Paint_reset">https://fiddle.skia.org/c/@Paint_reset</a>
     */
    @NotNull
    @Contract("-> this")
    public Paint reset() {
    ...
    /**
     * Returns true if pixels on the active edges of Path may be drawn with partial
     * transparency.
     *
     ...
     *
     * @see <a href=
     *      "https://fiddle.skia.org/c/@Paint_setStyle">https://fiddle.skia.org/c/@Paint_setStyle</a>
     * @see <a href=
     *      "https://fiddle.skia.org/c/@Stroke_Width">https://fiddle.skia.org/c/@Stroke_Width</a>
     */
    @NotNull
     ...
     * Use helpers {@link Color#getA(int)}, {@link Color#getR(int)},
     * {@link Color#getG(int)}, and {@link Color#getB(int)} to extract
     * a color component.
     *
    ...
    /**
     * Retrieves alpha and RGB, unpremultiplied, as four floating point values. RGB
     * are
     * extended sRGB values (sRGB gamut, and encoded with the sRGB transfer
     * function).
     *
     ...
     *
     * @see <a href=
     *      "https://fiddle.skia.org/c/@Paint_setColor">https://fiddle.skia.org/c/@Paint_setColor</a>
     */
    @NotNull
    @Contract("_ -> this")
    ...
    /**
     * Sets color used when drawing solid fills. The color components range from 0
     * to 255.
     ...
     *
     * @see <a href=
     *      "https://fiddle.skia.org/c/@Paint_setARGB">https://fiddle.skia.org/c/@Paint_setARGB</a>
     */
    @NotNull
     ...
     * A stroke-width of zero is treated as "hairline" width. Hairlines are always
     * exactly one
     * pixel wide in device space (their thickness does not change as the canvas is
     * scaled).
     * Negative stroke-widths are invalid; setting a negative width will have no
     * effect.
     *
     * @param width zero thickness for hairline; greater than zero for pen thickness
     *
     * @see <a href=
     *      "https://fiddle.skia.org/c/@Miter_Limit">https://fiddle.skia.org/c/@Miter_Limit</a>
     * @see <a href=
     *      "https://fiddle.skia.org/c/@Paint_setStrokeWidth">https://fiddle.skia.org/c/@Paint_setStrokeWidth</a>
     */
    @NotNull
    @Contract("_ -> this")
     ...
     *
     * @see <a href=
     *      "https://fiddle.skia.org/c/@Paint_setStrokeMiter">https://fiddle.skia.org/c/@Paint_setStrokeMiter</a>
     */
    @NotNull
    @Contract("_ -> this")
     ...
     *
     * @see <a href=
     *      "https://fiddle.skia.org/c/@Paint_setStrokeCap_a">https://fiddle.skia.org/c/@Paint_setStrokeCap_a</a>
     * @see <a href=
     *      "https://fiddle.skia.org/c/@Paint_setStrokeCap_b">https://fiddle.skia.org/c/@Paint_setStrokeCap_b</a>
     */
    @NotNull
    @Contract("!null -> this; null -> fail")
     ...
     *
     * @see <a href=
     *      "https://fiddle.skia.org/c/@Paint_setStrokeJoin">https://fiddle.skia.org/c/@Paint_setStrokeJoin</a>
     */
    @NotNull
    @Contract("!null -> this; null -> fail")
     ...
     * @param resScale if &gt; 1, increase precision, else if (0 &lt; resScale &lt;
     *                 1) reduce precision
    ...
    public Path getFillPath(@NotNull Path src, @Nullable Rect cull, float resScale) {
        try {
            ...
            if (cull == null)
                ...
                return new Path(_nGetFillPathCull(_ptr, Native.getPtr(src), cull._left, cull._top, cull._right,
                        cull._bottom, resScale));
        } finally {
            ReferenceUtil.reachabilityFence(this);
     ...
     * @see <a href=
     *      "https://fiddle.skia.org/c/@Paint_refShader">https://fiddle.skia.org/c/@Paint_refShader</a>
     */
    @Nullable
    ...
    /**
     * @param shader how geometry is filled with color; if null, color is used
     *               instead
     *
     * @see <a href=
     *      "https://fiddle.skia.org/c/@Color_Filter_Methods">https://fiddle.skia.org/c/@Color_Filter_Methods</a>
     * @see <a href=
     *      "https://fiddle.skia.org/c/@Paint_setShader">https://fiddle.skia.org/c/@Paint_setShader</a>
     */
    @NotNull
    @Contract("_ -> this")
     ...
     * @see <a href=
     *      "https://fiddle.skia.org/c/@Paint_refColorFilter">https://fiddle.skia.org/c/@Paint_refColorFilter</a>
     */
    @Nullable
     ...
     *
     * @see <a href=
     *      "https://fiddle.skia.org/c/@Blend_Mode_Methods">https://fiddle.skia.org/c/@Blend_Mode_Methods</a>
     * @see <a href=
     *      "https://fiddle.skia.org/c/@Paint_setColorFilter">https://fiddle.skia.org/c/@Paint_setColorFilter</a>
     */
    @NotNull
    @Contract("_ -> this")
     ...
     * @see <a href=
     *      "https://fiddle.skia.org/c/@Paint_refPathEffect">https://fiddle.skia.org/c/@Paint_refPathEffect</a>
     */
    @Nullable
     ...
     *
     * @see <a href=
     *      "https://fiddle.skia.org/c/@Mask_Filter_Methods">https://fiddle.skia.org/c/@Mask_Filter_Methods</a>
     * @see <a href=
     *      "https://fiddle.skia.org/c/@Paint_setPathEffect">https://fiddle.skia.org/c/@Paint_setPathEffect</a>
     */
    @NotNull
    @Contract("_ -> this")
     ...
     * @see <a href=
     *      "https://fiddle.skia.org/c/@Paint_refMaskFilter">https://fiddle.skia.org/c/@Paint_refMaskFilter</a>
     */
    @Nullable
     ...
     *
     * @see <a href=
     *      "https://fiddle.skia.org/c/@Paint_setMaskFilter">https://fiddle.skia.org/c/@Paint_setMaskFilter</a>
     * @see <a href=
     *      "https://fiddle.skia.org/c/@Typeface_Methods">https://fiddle.skia.org/c/@Typeface_Methods</a>
     */
    @NotNull
    @Contract("_ -> this")
     ...
     * @see <a href=
     *      "https://fiddle.skia.org/c/@Paint_refImageFilter">https://fiddle.skia.org/c/@Paint_refImageFilter</a>
     */
    @Nullable
     ...
     *
     * @see <a href=
     *      "https://fiddle.skia.org/c/@Draw_Looper_Methods">https://fiddle.skia.org/c/@Draw_Looper_Methods</a>
     * @see <a href=
     *      "https://fiddle.skia.org/c/@Paint_setImageFilter">https://fiddle.skia.org/c/@Paint_setImageFilter</a>
     */
    @NotNull
    @Contract("_ -> this")
     ...
     *
     * @see <a href=
     *      "https://fiddle.skia.org/c/@Paint_nothingToDraw">https://fiddle.skia.org/c/@Paint_nothingToDraw</a>
     */
    ...
    public static native long _nGetFillPathCull(long ptr, long path, float left, float top, float right, float bottom,
            float resScale);
