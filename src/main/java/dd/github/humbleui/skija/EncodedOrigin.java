...
public enum EncodedOrigin {
     ...
     * a matrix
     * that transforms the source rectangle with upper left corner at [0, 0] and
     * origin to a correctly
     ...
     * case the width
     * and height of the source data are swapped relative to a correctly oriented
     * destination.
     */
