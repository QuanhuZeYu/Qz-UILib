...
public enum ColorType {
    ...
    @ApiStatus.Internal
    public static final ColorType[] _values = values();
    ...
    /**
     * <p>
     * Returns a valid ColorAlphaType for colorType. If there is more than one valid
     * canonical
     * ColorAlphaType, set to alphaType, if valid.
     * </p>
     *
     * <p>
     * Returns null only if alphaType is {@link ColorAlphaType#UNKNOWN}, color type
     * is not
     * {@link #UNKNOWN}, and ColorType is not always opaque.
     * </p>
     *
    ...
    @ApiStatus.Internal
    public static native boolean _nIsAlwaysOpaque(int value);
}
