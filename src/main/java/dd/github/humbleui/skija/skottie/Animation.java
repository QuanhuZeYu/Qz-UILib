...
public class Animation extends Managed {
     ...
     * relative to {@link getDuration()} * {@link getFPS()}.
     * </p>
     *
     * <p>
     * Fractional values are allowed and meaningful - e.g.
     * 0.0 → first frame 1.0 → second frame 0.5 → halfway between first and second
     * frame
     * </p>
     *
     * @param t frame index
    ...
    @ApiStatus.Internal
    public static native void _nRender(long ptr, long canvasPtr, float left, float top, float right, float bottom,
            int flags);
