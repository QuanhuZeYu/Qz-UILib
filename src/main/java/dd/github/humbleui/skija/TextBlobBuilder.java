...
public class TextBlobBuilder extends Managed {
     ...
     *
     * @see <a href=
     *      "https://fiddle.skia.org/c/@TextBlobBuilder_empty_constructor">https://fiddle.skia.org/c/@TextBlobBuilder_empty_constructor</a>
     */
     ...
     *
     * @see <a href=
     *      "https://fiddle.skia.org/c/@TextBlobBuilder_make">https://fiddle.skia.org/c/@TextBlobBuilder_make</a>
     */
    @Nullable
    ...
    @ApiStatus.Internal
    public static native void _nAppendRun(long ptr, long fontPtr, short[] glyphs, float x, float y, Rect bounds);

    @ApiStatus.Internal
    public static native void _nAppendRunPosH(long ptr, long fontPtr, short[] glyphs, float[] xs, float y, Rect bounds);

    @ApiStatus.Internal
    public static native void _nAppendRunPos(long ptr, long fontPtr, short[] glyphs, float[] pos, Rect bounds);

    @ApiStatus.Internal
    public static native void _nAppendRunRSXform(long ptr, long fontPtr, short[] glyphs, float[] xform);
}
