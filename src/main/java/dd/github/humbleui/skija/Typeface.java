...
public class Typeface extends RefCnt {
    ...
    /**
     * It is possible the number of axes can be retrieved but actual position
     * cannot.
     *
     * @return the variation coordinates describing the position of this typeface in
     *         design variation space, null if there’s no variations
     */
    @Nullable
    ...
    /**
     * @return true if the two typefaces reference the same underlying font,
     *         treating null as the default font
     */
    @ApiStatus.Internal
    @Override
     ...
     * @throws IllegalArgumentException If the file does not exist, or is not a
     *                                  valid font file
     */
    @NotNull
     ...
     * @throws IllegalArgumentException If the data is null, or is not a valid font
     *                                  file
     */
    @NotNull
    ...
    /**
     * Return a new typeface based on this typeface but parameterized as specified
     * in the
     * variation. If the variation does not supply an argument for a parameter
     * in the font then the value from this typeface will be used as the value for
     * that argument.
     *
        ...
        try {
            ...
            if (ptr == 0)
                throw new IllegalArgumentException(
                        "Failed to clone Typeface " + this + " with " + Arrays.toString(variations));
            return new Typeface(ptr);
        } finally {
            ReferenceUtil.reachabilityFence(this);
        }
    ...
    /**
     * Return an immutable copy of the requested font table, or null if that table
     * was
     * not found.
     *
     ...
     *
     * @return adjustment array (one less than glyphs), or null if no kerning should
     *         be applied
     */
    @Nullable
    ...
    /**
     * @return the family name for this typeface. The language of the name is
     *         whatever the host platform chooses
     */
    ...
    /**
     * Return a rectangle (scaled to 1-pt) that represents the union of the bounds
     * of all
     * of the glyphs, but each one positioned at (0,). This may be conservatively
     * large, and
    ...
    @ApiStatus.Internal
    public static native boolean _nIsFixedPitch(long ptr);

    @ApiStatus.Internal
    public static native FontVariation[] _nGetVariations(long ptr);

    @ApiStatus.Internal
    public static native FontVariationAxis[] _nGetVariationAxes(long ptr);

    @ApiStatus.Internal
    public static native int _nGetUniqueId(long ptr);
    ...
    @ApiStatus.Internal
    public static native long _nMakeFromName(String name, int fontStyle);

    @ApiStatus.Internal
    public static native long _nMakeFromFile(String path, int index);

    @ApiStatus.Internal
    public static native long _nMakeFromData(long dataPtr, int index);

    @ApiStatus.Internal
    public static native long _nMakeClone(long ptr, FontVariation[] variations, int collectionIndex);

    @ApiStatus.Internal
    public static native short[] _nGetUTF32Glyphs(long ptr, int[] uni);

    @ApiStatus.Internal
    public static native short _nGetUTF32Glyph(long ptr, int unichar);

    @ApiStatus.Internal
    public static native int _nGetGlyphsCount(long ptr);

    @ApiStatus.Internal
    public static native int _nGetTablesCount(long ptr);

    @ApiStatus.Internal
    public static native int[] _nGetTableTags(long ptr);

    @ApiStatus.Internal
    public static native long _nGetTableSize(long ptr, int tag);

    @ApiStatus.Internal
    public static native long _nGetTableData(long ptr, int tag);

    @ApiStatus.Internal
    public static native int _nGetUnitsPerEm(long ptr);

    @ApiStatus.Internal
    public static native int[] _nGetKerningPairAdjustments(long ptr, short[] glyphs);

    @ApiStatus.Internal
    public static native FontFamilyName[] _nGetFamilyNames(long ptr);

    @ApiStatus.Internal
    public static native String _nGetFamilyName(long ptr);
