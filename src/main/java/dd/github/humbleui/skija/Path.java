 ...
 *
 * <p>
 * Adding a close verb makes the geometry into a continuous loop, a closed
 * contour.
...
public class Path extends Managed implements Iterable<PathSegment> {
    ...
    /**
     * Constructs an empty Path. By default, Path has no verbs, no {@link Point},
     * and no weights.
    ...
    /**
     * Compares this path and o; Returns true if {@link PathFillMode}, verb array,
     * Point array, and weights
     * are equivalent.
     *
     ...
     *
     * @see <a href=
     *      "https://fiddle.skia.org/c/@Path_isInterpolatable">https://fiddle.skia.org/c/@Path_isInterpolatable</a>
     */
     ...
     * the same size as ending Point array. Call {@link #isInterpolatable(Path)} to
     * check Path
     ...
     * @return interpolated Path if Path contain same number of Point, null
     *         otherwise
     *
     * @see <a href=
     *      "https://fiddle.skia.org/c/@Path_interpolate">https://fiddle.skia.org/c/@Path_interpolate</a>
     */
     ...
     *
     * @see <a href=
     *      "https://fiddle.skia.org/c/@Path_isOval">https://fiddle.skia.org/c/@Path_isOval</a>
     */
    public Rect isOval() {
        try {
            Stats.onNativeCall();
     ...
     *
     * @see <a href=
     *      "https://fiddle.skia.org/c/@Path_isRRect">https://fiddle.skia.org/c/@Path_isRRect</a>
     */
     ...
     *
     * <p>
     * Removes verb array, Point array, and weights, and sets FillMode to
     ...
     *
     * @see <a href=
     *      "https://fiddle.skia.org/c/@Path_reset">https://fiddle.skia.org/c/@Path_reset</a>
     */
    public Path reset() {
        Stats.onNativeCall();
        _nReset(_ptr);
     ...
     *
     * <p>
     * Use {@link #rewind()} instead of {@link #reset()} if Path storage will be
     * reused and performance
     * is critical.
     * </p>
     *
     * @return this
     *
     * @see <a href=
     *      "https://fiddle.skia.org/c/@Path_rewind">https://fiddle.skia.org/c/@Path_rewind</a>
     */
    public Path rewind() {
        Stats.onNativeCall();
        _nRewind(_ptr);
     ...
     *
     * <p>
     * Empty Path may have FillMode but has no {@link Point}, {@link PathVerb}, or
     * conic weight.
     * {@link Path()} constructs empty Path; {@link #reset()} and {@link #rewind()}
     * make Path empty.
     * </p>
     *
     ...
     *
     * <p>
     * Contour is closed if Path Verb array was last modified by
     * {@link #closePath()}. When stroked,
     * closed contour draws {@link PaintStrokeJoin} instead of
     * {@link PaintStrokeCap} at first and last Point.
     * </p>
     *
     * @return true if the last contour ends with a {@link PathVerb#CLOSE}
     *
     * @see <a href=
     *      "https://fiddle.skia.org/c/@Path_isLastContourClosed">https://fiddle.skia.org/c/@Path_isLastContourClosed</a>
     */
    ...
    /**
     * Returns true for finite Point array values between negative Float.MIN_VALUE
     * and
     ...
     * allowing
     * {@link Surface} to attach a cache of data which speeds repeated drawing. If
     * true, {@link Surface}
     ...
     * GPU surface Path draws are affected by volatile for some shadows and concave
     * geometries.
     * </p>
     *
     ...
     *
     * @see <a href=
     *      "https://fiddle.skia.org/c/@Path_IsLineDegenerate">https://fiddle.skia.org/c/@Path_IsLineDegenerate</a>
     */
     ...
     *              if false, returns true if p1, p2, and p3 are equal or nearly
     *              equal
     ...
     *              if false, returns true if p1, p2, p3, and p4 are equal or nearly
     *              equal
     ...
     *
     * @see <a href=
     *      "https://fiddle.skia.org/c/@Path_isLine">https://fiddle.skia.org/c/@Path_isLine</a>
     */
     ...
     *
     * @see <a href=
     *      "https://fiddle.skia.org/c/@Path_countPoints">https://fiddle.skia.org/c/@Path_countPoints</a>
     */
     ...
     *
     * @see <a href=
     *      "https://fiddle.skia.org/c/@Path_getPoint">https://fiddle.skia.org/c/@Path_getPoint</a>
     */
     ...
     *
     * @see <a href=
     *      "https://fiddle.skia.org/c/@Path_getPoints">https://fiddle.skia.org/c/@Path_getPoints</a>
     */
    ...
    /**
     * Returns the number of verbs: {@link PathVerb#MOVE}, {@link PathVerb#LINE},
     * {@link PathVerb#QUAD}, {@link PathVerb#CONIC},
     * {@link PathVerb#CUBIC}, and {@link PathVerb#CLOSE}; added to Path.
     *
     * @return length of verb array
     *
     * @see <a href=
     *      "https://fiddle.skia.org/c/@Path_countVerbs">https://fiddle.skia.org/c/@Path_countVerbs</a>
     */
     ...
     *
     * @see <a href=
     *      "https://fiddle.skia.org/c/@Path_getVerbs">https://fiddle.skia.org/c/@Path_getVerbs</a>
     */
     ...
     *
     * @see <a href=
     *      "https://fiddle.skia.org/c/@Path_swap">https://fiddle.skia.org/c/@Path_swap</a>
     */
     ...
     *
     * <p>
     * Returns (0, 0, 0, 0) if Path contains no points. Returned bounds width and
     * height may
     * be larger or smaller than area affected when Path is drawn.
     * </p>
     *
     * <p>
     * Rect returned includes all Point added to Path, including Point associated
     * with
    ...
    /**
     * <p>
     * Updates internal bounds so that subsequent calls to {@link #getBounds()} are
     * instantaneous.
     * Unaltered copies of Path may also access cached bounds through
     * {@link #getBounds()}.
     * </p>
     *
     * <p>
     ...
     * the maximum extent of the quad, conic, or cubic; is slower than
     * {@link #getBounds()};
     ...
     *
     * @see <a href=
     *      "https://fiddle.skia.org/c/@Path_computeTightBounds">https://fiddle.skia.org/c/@Path_computeTightBounds</a>
     */
     ...
     *
     * @see <a href=
     *      "https://fiddle.skia.org/c/@Path_conservativelyContainsRect">https://fiddle.skia.org/c/@Path_conservativelyContainsRect</a>
     */
    ...
    /**
     * <p>
     * Grows Path verb array and Point array to contain extraPtCount additional
     * Point.
     ...
     *
     * @see <a href=
     *      "https://fiddle.skia.org/c/@Path_incReserve">https://fiddle.skia.org/c/@Path_incReserve</a>
     */
     ...
     *
     * @see <a href=
     *      "https://fiddle.skia.org/c/@Path_moveTo">https://fiddle.skia.org/c/@Path_moveTo</a>
     */
     ...
     *
     * @see <a href=
     *      "https://fiddle.skia.org/c/@Path_rMoveTo">https://fiddle.skia.org/c/@Path_rMoveTo</a>
     */
     ...
     *
     * <p>
     * lineTo() appends {@link PathVerb#MOVE} to verb array and (0, 0) to Point
     * array, if needed.
     * lineTo() then appends {@link PathVerb#LINE} to verb array and (x, y) to Point
     * array.
     * </p>
     *
     ...
     *
     * @see <a href=
     *      "https://fiddle.skia.org/c/@Path_lineTo">https://fiddle.skia.org/c/@Path_lineTo</a>
     */
    ...
    /**
     * <p>
     * Adds line from last point to Point p. If Path is empty, or last
     * {@link PathVerb} is
     * {@link PathVerb#CLOSE}, last point is set to (0, 0) before adding line.
     * </p>
     *
     * <p>
     * lineTo() first appends {@link PathVerb#MOVE} to verb array and (0, 0) to
     * Point array, if needed.
     * lineTo() then appends {@link PathVerb#LINE} to verb array and Point p to
     * Point array.
     * </p>
     *
    ...
    /**
     * <p>
     * Adds line from last point to vector (dx, dy). If Path is empty, or last
     * {@link PathVerb} is
     * {@link PathVerb#CLOSE}, last point is set to (0, 0) before adding line.
     * </p>
     *
     * <p>
     * Appends {@link PathVerb#MOVE} to verb array and (0, 0) to Point array, if
     * needed;
     ...
     *
     * @see <a href=
     *      "https://fiddle.skia.org/c/@Path_rLineTo">https://fiddle.skia.org/c/@Path_rLineTo</a>
     * @see <a href=
     *      "https://fiddle.skia.org/c/@Quad_a">https://fiddle.skia.org/c/@Quad_a</a>
     * @see <a href=
     *      "https://fiddle.skia.org/c/@Quad_b">https://fiddle.skia.org/c/@Quad_b</a>
     */
     ...
     * If Path is empty, or last {@link PathVerb} is {@link PathVerb#CLOSE}, last
     * point is set to (0, 0)
     * before adding quad.
     *
     * Appends {@link PathVerb#MOVE} to verb array and (0, 0) to Point array, if
     ...
     *
     * @see <a href=
     *      "https://fiddle.skia.org/c/@Path_quadTo">https://fiddle.skia.org/c/@Path_quadTo</a>
     */
     ...
     *
     * @see <a href=
     *      "https://fiddle.skia.org/c/@Conic_Weight_a">https://fiddle.skia.org/c/@Conic_Weight_a</a>
     * @see <a href=
     *      "https://fiddle.skia.org/c/@Conic_Weight_b">https://fiddle.skia.org/c/@Conic_Weight_b</a>
     * @see <a href=
     *      "https://fiddle.skia.org/c/@Conic_Weight_c">https://fiddle.skia.org/c/@Conic_Weight_c</a>
     * @see <a href=
     *      "https://fiddle.skia.org/c/@Path_rQuadTo">https://fiddle.skia.org/c/@Path_rQuadTo</a>
     */
     ...
     *
     * <p>
     * If w is finite and not one, next appends {@link PathVerb#CONIC} to verb
     * array,
     * and w is recorded as conic weight; otherwise, if w is one, appends
     * {@link PathVerb#QUAD} to verb array; or if w is not finite, appends
     * {@link PathVerb#LINE}
     * twice to verb array.
     * </p>
     *
     ...
     * (x3, y3). If Path is empty, or last {@link PathVerb} is
     * {@link PathVerb#CLOSE}, last point is set to
     ...
     * Appends {@link PathVerb#MOVE} to verb array and (0, 0) to Point array, if
     * needed;
     * then appends {@link PathVerb#CUBIC} to verb array; and (x1, y1), (x2, y2),
     * (x3, y3)
     * to Point array.
     * </p>
     *
     ...
     * Point p3. If Path is empty, or last {@link PathVerb} is
     * {@link PathVerb#CLOSE}, last point is set to
     * (0, 0) before adding cubic.
     * </p>
     *
     ...
     * <p>
     * Appends {@link PathVerb#MOVE} to verb array and (0, 0) to Point array,
     * if needed; then appends {@link PathVerb#CUBIC} to verb array; and appends
     * cubic
     ...
     *
     * <p>
     * arcTo() adds line connecting Path last Point to initial arc Point if
     * forceMoveTo
     * is false and Path is not empty. Otherwise, added contour begins with first
     * point
     ...
     * @param sweepAngle  sweep, in degrees. Positive is clockwise; treated modulo
     *                    360
     * @param forceMoveTo true to start a new contour with arc
     * @return reference to Path
     *
     * @see <a href=
     *      "https://fiddle.skia.org/c/@Path_arcTo">https://fiddle.skia.org/c/@Path_arcTo</a>
     */
    ...
    /**
     * <p>
     * Appends arc to Path, after appending line if needed. Arc is implemented by
     * conic
     * weighted to describe part of circle. Arc is contained by tangent from
     * last Path point to (x1, y1), and tangent from (x1, y1) to (x2, y2). Arc
     * is part of circle sized to radius, positioned so it touches both tangent
     * lines.
     * </p>
     *
     * <p>
     * If last Path Point does not start Arc, tangentArcTo appends connecting Line
     * to Path.
     ...
     * tangents are nearly parallel, tangentArcTo appends Line from last Path Point
     * to (x1, y1).
     * </p>
     *
     * <p>
     ...
     *
     * <p>
     * tangentArcTo implements the functionality of PostScript arct and HTML Canvas
     * tangentArcTo.
     * </p>
     *
     ...
     *
     * @see <a href=
     *      "https://fiddle.skia.org/c/@Path_arcTo_2_a">https://fiddle.skia.org/c/@Path_arcTo_2_a</a>
     * @see <a href=
     *      "https://fiddle.skia.org/c/@Path_arcTo_2_b">https://fiddle.skia.org/c/@Path_arcTo_2_b</a>
     * @see <a href=
     *      "https://fiddle.skia.org/c/@Path_arcTo_2_c">https://fiddle.skia.org/c/@Path_arcTo_2_c</a>
     */
     ...
     * <p>
     * Arc sweep is always less than 180 degrees. If radius is zero, or if
     * tangents are nearly parallel, tangentArcTo() appends line from last Path
     * Point to p1.
     * </p>
     *
     * <p>
     ...
     *
     * <p>
     * tangentArcTo() implements the functionality of PostScript arct and HTML
     * Canvas tangentArcTo.
     * </p>
     *
     ...
     *
     * <p>
     * Arc sweep is always less than 360 degrees. ellipticalArcTo() appends line to
     * (x, y) if
     * either radii are zero, or if last Path Point equals (x, y). ellipticalArcTo()
     * scales radii
     ...
     *
     * <p>
     * ellipticalArcTo() implements the functionality of SVG arc, although SVG
     * sweep-flag value
     ...
     * @return reference to Path
     */
    public Path ellipticalArcTo(float rx, float ry, float xAxisRotate, PathEllipseArc arc, PathDirection direction,
            float x, float y) {
        Stats.onNativeCall();
    ...
    /**
     * <p>
     * Appends arc to Path. Arc is implemented by one or more conic weighted to
     * describe
     * part of oval with radii (r.fX, r.fY) rotated by xAxisRotate degrees. Arc
     * curves
     ...
     * Arc sweep is always less than 360 degrees. ellipticalArcTo() appends line to
     * xy if either
     * radii are zero, or if last Path Point equals (xy.fX, xy.fY).
     * ellipticalArcTo() scales radii r to
     * fit last Path Point and xy if both are greater than zero but too small to
     * describe
     * an arc.
     * </p>
     *
     ...
     * ellipticalArcTo() implements the functionality of SVG arc, although SVG
     * sweep-flag value is
     * opposite the integer value of sweep; SVG sweep-flag uses 1 for clockwise,
     * while
    ...
    /**
     * <p>
     * Appends arc to Path, relative to last Path Point. Arc is implemented by one
     * or
     * more conic, weighted to describe part of oval with radii (rx, ry) rotated by
     * xAxisRotate degrees. Arc curves from last Path Point to relative end Point:
     * (dx, dy), choosing one of four possible routes: clockwise or
     * counterclockwise, and smaller or larger. If Path is empty, the start arc
     * Point
     * is (0, 0).
     * </p>
     *
     * <p>
     * Arc sweep is always less than 360 degrees. rEllipticalArcTo() appends line to
     * end Point
     * if either radii are zero, or if last Path Point equals end Point.
     * rEllipticalArcTo() scales radii (rx, ry) to fit last Path Point and end Point
     * if both are
     ...
     *
     * <p>
     * rEllipticalArcTo() implements the functionality of svg arc, although SVG
     * "sweep-flag" value is
     * opposite the integer value of sweep; SVG "sweep-flag" uses 1 for clockwise,
     * while
     * {@link PathDirection#CLOCKWISE} cast to int is zero.
     ...
     * @return reference to Path
     */
    public Path rEllipticalArcTo(float rx, float ry, float xAxisRotate, PathEllipseArc arc, PathDirection direction,
            float dx, float dy) {
        Stats.onNativeCall();
    ...
    /**
     * <p>
     * Appends {@link PathVerb#CLOSE} to Path. A closed contour connects the first
     * and last Point
     * with line, forming a continuous loop. Open and closed contour draw the same
     * with {@link PaintMode#FILL}. With {@link PaintMode#STROKE}, open contour
     * draws
     ...
     *
     * <p>
     * closePath() has no effect if Path is empty or last Path {@link PathVerb} is
     * {@link PathVerb#CLOSE}.
     * </p>
     *
     * @return reference to Path
     *
     * @see <a href=
     *      "https://fiddle.skia.org/c/@Path_close">https://fiddle.skia.org/c/@Path_close</a>
     */
     ...
     *
     * <p>
     * Every third point in array shares last Point of previous quad and first Point
     * of
     ...
     *
     * <p>
     * conic weight determines the amount of influence conic control point has on
     * the curve.
     * </p>
     *
     * <p>
     * w less than one represents an elliptical section. w greater than one
     * represents
     ...
     * @param pow2 quad count, as power of two, normally 0 to 5 (1 to 32 quad
     *             curves)
     ...
     * </p>
     *
     * rect may be smaller than the Path bounds. Path bounds may include
     * {@link PathVerb#MOVE} points
     * that do not alter the area drawn by the returned rect.
     *
     * @return bounds if Path contains Rect, null otherwise
     *
     * @see <a href=
     *      "https://fiddle.skia.org/c/@Path_isRect">https://fiddle.skia.org/c/@Path_isRect</a>
     */
    public Rect isRect() {
        try {
            Stats.onNativeCall();
    ...
    /**
     * Adds Rect to Path, appending {@link PathVerb#MOVE}, three
     * {@link PathVerb#LINE}, and {@link PathVerb#CLOSE},
     ...
     *
     * @see <a href=
     *      "https://fiddle.skia.org/c/@Path_addRect">https://fiddle.skia.org/c/@Path_addRect</a>
     */
     ...
     * {@link PathVerb#LINE}, and {@link PathVerb#CLOSE},
     * starting with top-left corner of Rect; followed by top-right, bottom-right,
     * and bottom-left if dir is {@link PathDirection#CLOCKWISE}; or followed by
     * bottom-left,
     * bottom-right, and top-right if dir is
     * {@link PathDirection#COUNTER_CLOCKWISE}.
     *
     * @param rect Rect to add as a closed contour
     ...
     * Adds Rect to Path, appending {@link PathVerb#MOVE}, three
     * {@link PathVerb#LINE}, and {@link PathVerb#CLOSE}.
     * If dir is {@link PathDirection#CLOCKWISE}, Rect corners are added clockwise;
     * if dir is
     * {@link PathDirection#COUNTER_CLOCKWISE}, Rect corners are added
     * counterclockwise.
     * start determines the first corner added.
     *
     * @param rect  Rect to add as a closed contour
     * @param dir   Direction to wind added contour
     * @param start initial corner of Rect to add. 0 for top left, 1 for top right,
     *              2 for lower right, 3 for lower left
     * @return reference to Path
     *
     * @see <a href=
     *      "https://fiddle.skia.org/c/@Path_addRect_2">https://fiddle.skia.org/c/@Path_addRect_2</a>
     */
    ...
    /**
     * <p>
     * Adds oval to path, appending {@link PathVerb#MOVE}, four
     * {@link PathVerb#CONIC}, and {@link PathVerb#CLOSE}.
     * </p>
     *
     * <p>
     * Oval is upright ellipse bounded by Rect oval with radii equal to half oval
     * width
     * and half oval height. Oval begins at (oval.fRight, oval.centerY()) and
     * continues
     * clockwise.
     * </p>
     *
     ...
     *
     * @see <a href=
     *      "https://fiddle.skia.org/c/@Path_addOval">https://fiddle.skia.org/c/@Path_addOval</a>
     */
     ...
     * and half oval height. Oval begins at (oval.fRight, oval.centerY()) and
     * continues
     * clockwise if dir is {@link PathDirection#CLOCKWISE}, counterclockwise if dir
     * is {@link PathDirection#COUNTER_CLOCKWISE}.
     * </p>
     *
     * @param oval bounds of ellipse added
     ...
     * @param oval  bounds of ellipse added
     * @param dir   Direction to wind ellipse
     * @param start index of initial point of ellipse. 0 for top, 1 for right, 2 for
     *              bottom, 3 for left
     * @return reference to Path
     *
     * @see <a href=
     *      "https://fiddle.skia.org/c/@Path_addOval_2">https://fiddle.skia.org/c/@Path_addOval_2</a>
     */
    ...
    /**
     * <p>
     * Adds circle centered at (x, y) of size radius to Path, appending
     * {@link PathVerb#MOVE},
     * four {@link PathVerb#CONIC}, and {@link PathVerb#CLOSE}. Circle begins at: (x
     * + radius, y)
     * </p>
     *
     * <p>
     ...
     * four {@link PathVerb#CONIC}, and {@link PathVerb#CLOSE}. Circle begins at: (x
     * + radius, y), continuing
     * clockwise if dir is {@link PathDirection#CLOCKWISE}, and counterclockwise if
     * dir is {@link PathDirection#COUNTER_CLOCKWISE}.
     * </p>
     *
     * <p>
     * Has no effect if radius is zero or negative.
     ...
     *
     * <p>
     * If sweepAngle &le; -360, or sweepAngle &ge; 360; and startAngle modulo 90 is
     * nearly
     ...
     *
     * @see <a href=
     *      "https://fiddle.skia.org/c/@Path_addArc">https://fiddle.skia.org/c/@Path_addArc</a>
     */
    ...
    /**
     * <p>
     * Adds rrect to Path, creating a new closed contour. RRect starts at top-left
     * of the lower-left corner and
     * winds clockwise.
     * </p>
     *
     * <p>
     ...
     *
     * @see <a href=
     *      "https://fiddle.skia.org/c/@Path_addRRect">https://fiddle.skia.org/c/@Path_addRRect</a>
     */
     ...
     * dir is {@link PathDirection#CLOCKWISE}, rrect starts at top-left of the
     * lower-left corner and
     * winds clockwise. If dir is {@link PathDirection#COUNTER_CLOCKWISE}, rrect
    ...
    /**
     * <p>
     * Adds rrect to Path, creating a new closed contour. If dir is
     * {@link PathDirection#CLOCKWISE}, rrect
     * winds clockwise; if dir is {@link PathDirection#COUNTER_CLOCKWISE}, rrect
     ...
     * @param rrect bounds and radii of rounded rectangle
     * @param dir   Direction to wind RRect
     * @param start index of initial point of RRect. 0 for top-right end of the arc
     *              at top left,
     *              1 for top-left end of the arc at top right, 2 for bottom-right
     *              end of top right arc, etc.
     * @return reference to Path
     *
     * @see <a href=
     *      "https://fiddle.skia.org/c/@Path_addRRect_2">https://fiddle.skia.org/c/@Path_addRRect_2</a>
     */
     ...
     * in pts array. If close is true, appends {@link PathVerb#CLOSE} to Path,
     * connecting
     ...
     *
     * @see <a href=
     *      "https://fiddle.skia.org/c/@Path_addPoly">https://fiddle.skia.org/c/@Path_addPoly</a>
     */
    ...
    /**
     * <p>
     * Adds contour created from line array, adding (pts.length / 2 - 1) line
     * segments.
     * Contour added starts at (pts[0], pts[1]), then adds a line for every
     * additional pair of floats
     * in pts array. If close is true, appends {@link PathVerb#CLOSE} to Path,
     * connecting
    ...
    /**
     * <p>
     * Appends src to Path, transformed by matrix. Transformed curves may have
     * different
     * verbs, Point, and conic weights.
     * </p>
     *
     ...
     *
     * @see <a href=
     *      "https://fiddle.skia.org/c/@Path_reverseAddPath">https://fiddle.skia.org/c/@Path_reverseAddPath</a>
     */
     ...
     *
     * @see <a href=
     *      "https://fiddle.skia.org/c/@Path_offset">https://fiddle.skia.org/c/@Path_offset</a>
     */
     ...
     *
     * @see <a href=
     *      "https://fiddle.skia.org/c/@Path_transform">https://fiddle.skia.org/c/@Path_transform</a>
     */
     ...
     *
     * @param matrix               matrix to apply to Path
     * @param dst                  overwritten, transformed copy of Path; may be
     *                             null
     * @param applyPerspectiveClip whether to apply perspective clipping
     * @return this
     *
     ...
     *
     * @see <a href=
     *      "https://fiddle.skia.org/c/@Path_getLastPt">https://fiddle.skia.org/c/@Path_getLastPt</a>
     */
    ...
    /**
     * Sets last point to (x, y). If Point array is empty, append
     * {@link PathVerb#MOVE} to
     ...
     *
     * @see <a href=
     *      "https://fiddle.skia.org/c/@Path_setLastPt">https://fiddle.skia.org/c/@Path_setLastPt</a>
     */
    ...
    /**
     * Sets the last point on the path. If Point array is empty, append
     * {@link PathVerb#MOVE} to
     ...
     *
     * @see <a href=
     *      "https://fiddle.skia.org/c/@Path_contains">https://fiddle.skia.org/c/@Path_contains</a>
     */
    ...
    /**
     * Writes text representation of Path to standard output. The representation may
     * be
     ...
     *
     * @see <a href=
     *      "https://fiddle.skia.org/c/@Path_dump_2">https://fiddle.skia.org/c/@Path_dump_2</a>
     */
    public Path dump() {
        Stats.onNativeCall();
        _nDump(_ptr);
     ...
     * be
     * directly compiled as C++ code. Floating point values are written
     * in hexadecimal to preserve their exact bit pattern. The output reconstructs
     * the
     * original Path.
     * </p>
     *
     ...
     *
     * @see <a href=
     *      "https://fiddle.skia.org/c/@Path_dumpHex">https://fiddle.skia.org/c/@Path_dumpHex</a>
     */
    public Path dumpHex() {
        Stats.onNativeCall();
        _nDumpHex(_ptr);
     ...
     *
     * @see <a href=
     *      "https://fiddle.skia.org/c/@Path_writeToMemory">https://fiddle.skia.org/c/@Path_writeToMemory</a>
     */
    ...
    /**
     * <p>
     * Returns Path that is the result of applying the Op to the first path and the
     * second path.
     * <p>
     ...
     *
     * @see <a href=
     *      "https://fiddle.skia.org/c/@Path_readFromMemory">https://fiddle.skia.org/c/@Path_readFromMemory</a>
     */
     ...
     *
     * <p>
     * Each time the path is modified, a different generation identifier will be
     * returned.
     ...
     *
     * @see <a href=
     *      "https://fiddle.skia.org/c/@Path_getGenerationID">https://fiddle.skia.org/c/@Path_getGenerationID</a>
     * @see <a href=
     *      "https://bugs.chromium.org/p/skia/issues/detail?id=1762">https://bugs.chromium.org/p/skia/issues/detail?id=1762</a>
     */
    ...
    public static native boolean _nIsQuadDegenerate(float x0, float y0, float x1, float y1, float x2, float y2,
            boolean exact);

    public static native boolean _nIsCubicDegenerate(float x0, float y0, float x1, float y1, float x2, float y2,
            float x3, float y3, boolean exact);
    ...
    public static native void _nArcTo(long ptr, float left, float top, float right, float bottom, float startAngle,
            float sweepAngle, boolean forceMoveTo);

    public static native void _nTangentArcTo(long ptr, float x1, float y1, float x2, float y2, float radius);

    public static native void _nEllipticalArcTo(long ptr, float rx, float ry, float xAxisRotate, int size,
            int direction, float x, float y);

    public static native void _nREllipticalArcTo(long ptr, float rx, float ry, float xAxisRotate, int size,
            int direction, float dx, float dy);

    public static native void _nClosePath(long ptr);

    public static native Point[] _nConvertConicToQuads(float x0, float y0, float x1, float y1, float x2, float y2,
            float w, int pow2);
    ...
    public static native void _nAddArc(long ptr, float l, float t, float r, float b, float startAngle,
            float sweepAngle);

    public static native void _nAddRRect(long ptr, float l, float t, float r, float b, float[] radii, int dir,
            int start);
