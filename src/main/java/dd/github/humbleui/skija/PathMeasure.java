...
public class PathMeasure extends Managed {
    ...
    /**
     * Initialize the pathmeasure with the specified path. The parts of the path
     * that are needed
    ...
    /**
     * Reset the pathmeasure with the specified path. The parts of the path that are
     * needed
     * are copied, so the client is free to modify/delete the path after this call.
     */
     ...
     * startD and stopD are pinned to legal values (0..getLength()). If startD &gt;
     * stopD
    ...
    @ApiStatus.Internal
    public static native long _nMakePath(long pathPtr, boolean forceClosed, float resScale);

    @ApiStatus.Internal
    public static native void _nSetPath(long ptr, long pathPtr, boolean forceClosed);

    @ApiStatus.Internal
    public static native float _nGetLength(long ptr);

    @ApiStatus.Internal
    public static native Point _nGetPosition(long ptr, float distance);

    @ApiStatus.Internal
    public static native Point _nGetTangent(long ptr, float distance);

    @ApiStatus.Internal
    public static native RSXform _nGetRSXform(long ptr, float distance);

    @ApiStatus.Internal
    public static native float[] _nGetMatrix(long ptr, float distance, boolean getPosition, boolean getTangent);

    @ApiStatus.Internal
    public static native boolean _nGetSegment(long ptr, float startD, float endD, long dstPtr, boolean startWithMoveTo);

    @ApiStatus.Internal
    public static native boolean _nIsClosed(long ptr);

    @ApiStatus.Internal
    public static native boolean _nNextContour(long ptr);
}
