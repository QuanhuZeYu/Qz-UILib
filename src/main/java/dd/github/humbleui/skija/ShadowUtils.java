...
public class ShadowUtils {
     ...
     * using a disc
     * light. The shadow may be cached, depending on the path type and canvas
     * matrix. If the
     ...
     * @param zPlaneParams        Values for the plane function which returns the Z
     *                            offset of the
     *                            occluder from the canvas based on local x and y
     *                            values (the current matrix is not applied).
     * @param lightPos            The 3D position of the light relative to the
     *                            canvas plane. This is
     *                            independent of the canvas's current matrix.
     * @param lightRadius         The radius of the disc light.
     * @param ambientColor        The color of the ambient shadow.
     * @param spotColor           The color of the spot shadow.
     * @param transparentOccluder The occluding object is not opaque. Knowing that
     *                            the occluder is opaque allows
     *                            us to cull shadow geometry behind it and improve
     *                            performance.
    ...
    public static native void _nDrawShadow(long canvasPtr, long pathPtr, float zPlaneX, float zPlaneY, float zPlaneZ,
            float lightPosX, float lightPosY, float lightPosZ, float lightRadius, int ambientColor, int spotColor,
            int flags);
