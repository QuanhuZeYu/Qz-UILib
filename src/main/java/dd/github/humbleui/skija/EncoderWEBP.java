...
public class EncoderWEBP {
    ...
    public static Data encode(@Nullable DirectContext ctx, @NotNull Image image, @NotNull EncodeWEBPOptions opts) {
        try {
            ...
            Stats.onNativeCall();
            long ptr = _nEncode(Native.getPtr(ctx), Native.getPtr(image), opts._compressionMode.ordinal(),
                    opts._quality);
    ...
    @ApiStatus.Internal
    public static native long _nEncode(long ctxPtr, long imagePtr, int compressionMode, float quality);
}
