...
void main(void) {
    ...
    blurred += texture2D(mainTex, texCoord + vec2(0.65, 0.0) * radiusStep) * 0.10;
    blurred += texture2D(mainTex, texCoord + vec2(0.0, -0.65) * radiusStep) * 0.10;
    blurred += texture2D(mainTex, texCoord + vec2(0.0, 0.65) * radiusStep) * 0.10;

    blurred += texture2D(mainTex, texCoord + vec2(-1.25, 0.0) * radiusStep) * 0.07;
    blurred += texture2D(mainTex, texCoord + vec2(1.25, 0.0) * radiusStep) * 0.07;
    blurred += texture2D(mainTex, texCoord + vec2(0.0, -1.25) * radiusStep) * 0.07;
    blurred += texture2D(mainTex, texCoord + vec2(0.0, 1.25) * radiusStep) * 0.07;

    blurred += texture2D(mainTex, texCoord + vec2(-0.9, -0.9) * radiusStep) * 0.05;
    blurred += texture2D(mainTex, texCoord + vec2(0.9, -0.9) * radiusStep) * 0.05;
    blurred += texture2D(mainTex, texCoord + vec2(-0.9, 0.9) * radiusStep) * 0.05;
    blurred += texture2D(mainTex, texCoord + vec2(0.9, 0.9) * radiusStep) * 0.05;
