...
/**
 * `UiLayoutDiagnosticsDocumentPageController` 的黑盒测试。
 */
public class UiLayoutDiagnosticsDocumentPageControllerTest {
    ...
    public void shouldRefreshHooksAndRespectInjectedScreenName() {
        ...
        fixture.runtimeView.setRuntimeStats(createRuntimeStats(UiDocumentScreens.UI_TEST_LAYOUT.getPageId()));
        fixture.controller.beforeDocumentFrame();
    ...
    private static UiRuntimeStats createRuntimeStats(String screenName) {
        return new UiRuntimeStats(screenName, 960, 540, 1920, 1080, 12_000_000L, 10_000_000L, 18_000_000L, 83.3D,
                8_000_000L, 7_500_000L, 1_500_000L, 3, 2, 1, 500_000L, 42L, 77, 9, "LabelWidget", 3_250_000L,
                "DocumentCardWidget", 6_500_000L, "measure=4.0ms, layout=2.0ms", 2, 30);
    }
    ...
    private static final class TestFixture {
        ...
        private final UiLayoutDiagnosticsDocumentPageController controller = new UiLayoutDiagnosticsDocumentPageController(
                documentUi, pageSurface, runtimeView, UiDocumentScreens.UI_TEST_LAYOUT.getPageId(), fontRuntimeStatsSource);
    }
    ...
    private static final class DeterministicTextMeasureService implements TextMeasureService {
        ...
        private int resolveCodePointWidth(int codepoint) {
            if (Character.isIdeographic(codepoint) || Character.UnicodeScript.of(codepoint) == Character.UnicodeScript.HAN) {
