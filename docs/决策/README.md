...
- [`DECISION-20260628-modern-config-new-mental-model.md`](DECISION-20260628-modern-config-new-mental-model.md) - 现代化配置页全新思维模型——三态四层软依赖架构
  ...
  废弃旧 modern-config 系列决策，不参考旧栈完全重新设计
...
- [`DECISION-20260701-scroll-api-slim-C1C6.md`](DECISION-20260701-scroll-api-slim-C1C6.md) - 滚动API全链路改进（P0-P4，C1-C6）：layoutDoneSignal 下移 runtime + scrollbar Props 删 contentChangedSignal + attach 去 contentChangedSignal 参数 + scrollbarContentSignal→showScrollbar boolean + forEach 无keyFn重载 + scrollList 一体化方法
