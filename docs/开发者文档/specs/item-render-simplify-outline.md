...
> 素材基线：`docs/开发者文档/架构图/08-物品渲染包装.md`（2026-08-13）、`docs/开发者文档/specs/item-visual-rendering-seam.md`、`AGENTS.md`、main 源码实时状态。
...
- `RequestResult.Status.ABORT_FRAME` 删除、`callsPerFrame` 删除——`HostImageRenderSession` 为 public 类，属 breaking；落在已锁定的 5.0.0 breaking major 版本内（`item-visual-rendering-seam.md` 第 43-49 行）。
