...
- 自动化固定 max width、footer 不滚动、error-over-dirty、现有保存语义、多 occurrence motion isolation、同帧/逐帧滚轮累计、反向滚轮、scrollbar 中途接管、跨帧 hover 几何同步、主树/overlay 首帧布局发布、三轮 settle 上限，以及 reveal 期间 hit-test/Tab 门禁与 Owner 恢复。
